$(document).ready(function(){
    ...
    buyAmount.addEventListener('input', (event) => {
      ...
      if (buySelectElem.value == 'BTC') {
        ...
        buyTransferInp.value = parseFloat(document.getElementById('usdt-price').innerHTML) * parseFloat(event.target.value);
    ...
    sellAmount.addEventListener('input', (event) => {
      if (sellSelectElem.value == 'BTC') {
        ...
        sellTransferInp.value = parseFloat(document.getElementById('usdt-price').innerHTML) * parseFloat(event.target.value);
